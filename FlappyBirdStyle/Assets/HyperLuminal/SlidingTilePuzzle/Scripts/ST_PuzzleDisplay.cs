...
public class ST_PuzzleDisplay : MonoBehaviour 
{
	...
	public Vector3 PuzzlePosition = new Vector3(0.0f, 0.0f, -10.0f);
	...
	void Start () 
	{
        ...
        this.transform.position = Camera.main.transform.position + PuzzlePosition; //PlayerPosition.localPosition ;
